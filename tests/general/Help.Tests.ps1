...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\JeaCertificateManager\functions", "$global:testroot\..\JeaCertificateManager\internal\functions"),
	
	[string]
	$ModuleName = "JeaCertificateManager",
...
$CommandPath = @(
    "$global:testroot\..\JeaCertificateManager\functions"
    "$global:testroot\..\JeaCertificateManager\internal\functions"
)
