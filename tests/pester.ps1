...
Remove-Module JeaCertificateManager -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\JeaCertificateManager\JeaCertificateManager.psd1"
Import-Module "$PSScriptRoot\..\JeaCertificateManager\JeaCertificateManager.psm1" -Force
